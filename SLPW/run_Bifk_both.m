...
stiffnesses = linspace(15e3,21e3,sizeB); % 5 -> 25
...
Xlabel = 'Stiffnesses of both legs, k (kN/m)';
Sym = 18;
% save('resultsBifkBNEWV4.mat')
save('resultsBifk_both.mat')
