function [  ] = bifurcationPlotDiff( filename,c1,c2 )
...
ALLplots = {StanceT;-Allinterleg;Speeds;AllGCrdot;GRFPeak1./BW;GRFPeak2./BW;XNetImpulse;rdotDiff;totalMomDiff};
...
Ylabels = {'Stance time (s)';'Inter-leg angle (rad)';'Walking speed (m/s)';'Spring velocity at mid-stance (m/s)';'FY1 / Body Weight';'FY2 / Body Weight';'Net X-impulse (Ns)';'rDotDiff';'Total impulse before collision (Ns)'};
