...
for bifurcation = 2:Bif
    
    x_axis = slopes(bifurcation)*-180/pi;
            ...
            switch event
                ...
                case 'hlstr'
                    ...
                    if step==maxsteps
                        ...
                        %% Plot eigenvalues
                        [ eigenVals ] = localStability( [th1_0,th2_0,th1dot_0,th2dot_0],step);
                        figure(1)
                        plot(eigenVals,'k.','MarkerSize',10)
                            
                        figure(2)
                        plot(x_axis,max(real(eigenVals)),'k.','MarkerSize',10)
