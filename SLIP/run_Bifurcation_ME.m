...
ME_total = linspace(840,870,plotSize);
...
Param.alphaA    = 24*-pi/180;
Param.alphaB    = 24*-pi/180;
Param.kA     = 18*1e3;
Param.kB     = 18*1e3;
Param.ME_0  = 860;
...
%                                 plot(TP1,FP1)
                                ...
                                if size(pks,1) == 2
                                    ...
                                    GRFPeak1(h,loopF-2) = NaN;
                                    GRFPeak2(h,loopF-2) = NaN;
                                end
                            end
...
Sym = NaN;
% save('resultsME_kis18.mat')
save('resultsME_kis18alphais24.mat')
